        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-xl shadow p-6 border-t-4 border-primary">
            ...
            <ul className="text-gray-600 space-y-2 text-sm">
              <li>
                <span className="font-semibold">Town:</span> Akpu (Akpujiogu)
              </li>
              <li>
                <span className="font-semibold">LGA:</span> Orumba South
              </li>
              <li>
                <span className="font-semibold">State:</span> Anambra State
              </li>
              <li>
