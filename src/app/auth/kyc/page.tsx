      ...
      <div style={{ background: "white", borderRadius: 20, boxShadow: "0 4px 24px rgba(0,0,0,0.08)", padding: 36, width: "100%", maxWidth: 480 }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 28 }}>
          ...
          <p style={{ color: "#6b7280", fontSize: 14, margin: 0 }}>
            All fields are required to join the community
          </p>
        ...
        <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            <label style={{ display: "flex", alignItems: "flex-start", gap: 10, cursor: "pointer" }}>
              ...
              <span style={{ fontSize: 13, color: "#374151", lineHeight: 1.5 }}>
                ...
                <Link href="/terms" target="_blank"
                  style={{ color: "#2d6a2d", fontWeight: 700, textDecoration: "none" }}>
                  Terms of Use
                </Link>{" "}
                and{" "}
          ...
          <button
            ...
            style={{
              background: loading || !agreed ? "#9ca3af" : "#2d6a2d",
              color: "white", border: "none", padding: "14px", borderRadius: 10,
              fontSize: 16, fontWeight: 700, cursor: loading || !agreed ? "not-allowed" : "pointer",
              fontFamily: "inherit",
            }}
          >
